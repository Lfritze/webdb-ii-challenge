Install knex and sqlite3 Database to be called car-dealer.db3, migration table to be called cars. Knex init with migrations, seeds, config. Point everything to ./data /migrations /seeds dbConfig.js
